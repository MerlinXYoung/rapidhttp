...
template <typename StringT>
inline bool THttpDocument<StringT>::CheckMethod() const noexcept {
    return !request_method_.empty();
}
template <typename StringT>
inline bool THttpDocument<StringT>::CheckUri() const noexcept {
    return !request_uri_.empty() && request_uri_[0] == '/';
}
template <typename StringT>
inline bool THttpDocument<StringT>::CheckStatusCode() const noexcept {
    return response_status_code_ >= 100 && response_status_code_ < 1000;
}
template <typename StringT>
inline bool THttpDocument<StringT>::CheckStatus() const noexcept {
    return !response_status_.empty();
}
template <typename StringT>
inline bool THttpDocument<StringT>::CheckVersion() const noexcept {
...
/// ------------------- fields get/set ---------------------
template <typename StringT>
inline StringT const& THttpDocument<StringT>::GetMethod() const noexcept {
